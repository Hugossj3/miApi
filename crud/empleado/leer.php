...
if($result->num_rows > 0){   
    $listaEmpleados["Empleados"]=array(); //Hace un array y dentro otro llamado ACTORES 
	while ($actor = $result->fetch_assoc()) { //Crea un array asociativo con cada actor	
       ...
       array_push($listaEmpleados["Empleados"], $datosExtraidos);//Hace un append al final de la lista 
    }    
