...
if ($result->num_rows > 0) {
    ...
    echo '<table border="1">';
    echo '<tr><th>ID</th><th>Nombre</th><th>Puesto</th><th>Correo</th><th>Telefono</th><th>Edicion</th><th colspan="3">Paro</th>
    ...
    while ($actor = $result->fetch_assoc()) { //Crea un array asociativo con cada actor	
        ...
        echo '<td>' . $correo . '</td>';
        echo '<td>' . $telefono . '</td>';
        echo "<td><a href='editar.php?id=$id&nombre=$nombre&puesto=$puesto&correo=$correo&telefono=$telefono'>Editar</a></td>";
...
<script>
    ...
    function miFuncion(miid) {
        ...
        xhr.open("POST", "../../crud/empleado/borrar.php", true);
